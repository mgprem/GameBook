        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    StatusExpire = table.Column<DateTime>(nullable: false),
                    ...
                    Website1 = table.Column<string>(nullable: true),
                    Website2 = table.Column<string>(nullable: true),
                    ...
                    CardLastFour = table.Column<string>(nullable: true),
                    TrialEndsAt = table.Column<DateTimeOffset>(nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(nullable: false)
                        .Annotation("MySQL:AutoIncrement", true),
                    IdGamebook = table.Column<int>(nullable: false),
                    Publish = table.Column<byte>(nullable: false),
                    Name = table.Column<string>(nullable: true),
                    ...
                    GamebooksId = table.Column<int>(nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Episodes", x => x.Id);
                    table.ForeignKey(
                        name: "FK_Episodes_Gamebooks_GamebooksId",
                        column: x => x.GamebooksId,
